...
class ProductionOrder(Document):
	...
	def make_time_logs(self, open_new=False):
		...
		timesheet = make_timesheet(self.name, self.company, self.business_unit)
	...
	def get_operations_data(self, data):
		ws = frappe.get_doc("Workstation", data.workstation)
		return {
			...
			'cost_center': ws.cost_center, 
			'hour_rate_electricity': ws.hour_rate_electricity,
			'hour_rate_water': ws.hour_rate_water,
			'hour_rate_gas': ws.hour_rate_gas,
			'hour_rate_consumable': ws.hour_rate_consumable,
			'hour_rate_labour': ws.hour_rate_labour,
			'hour_rate_rent': ws.hour_rate_rent,
...
@frappe.whitelist()
def make_timesheet(production_order, company, business_unit):
	timesheet = frappe.new_doc("Timesheet")
	timesheet.employee = ""
	timesheet.production_order = production_order
	timesheet.company = company
	timesheet.business_unit = business_unit
	return timesheet
