		...
		},
		{
			...
			"items": [
				...
				},
				{
					"type": "page",
					"name": "customer_geo",
					"label": _("Customer Geo"),
					"description": _("Define Customer Geolocation."),
				},
				{
					"type": "page",
					"name": "customers_map_view",
					"label": _("View Customers on Map"),
					"description": _("View Customers on Map."),
				},
