...
erpnext.financial_statements = {
	...
	"open_general_ledger": function(data) {
		...
		frappe.route_options = {
			...
			"business_unit": (business_unit) ? frappe.query_report_filters_by_name.business_unit.get_value() : undefined,
	...
	onload: function(report) {
		...
		report.page.add_inner_button(__("Balance Sheet"), function() {
			...
			frappe.set_route('query-report', 'Balance Sheet', {company: filters.company, business_unit: filters.business_unit});
		}, __('Financial Statements'));
		report.page.add_inner_button(__("Profit and Loss"), function() {
			var filters = report.get_values();
			frappe.set_route('query-report', 'Profit and Loss Statement', {company: filters.company, business_unit: filters.business_unit});
		}, __('Financial Statements'));
		report.page.add_inner_button(__("Cash Flow Statement"), function() {
			var filters = report.get_values();
			frappe.set_route('query-report', 'Cash Flow', {company: filters.company, business_unit: filters.business_unit});
		}, __('Financial Statements'));
	}
};
