			...
			for batch in sorted(iwb_map[item][wh]):
				...
				if qty_dict.opening_qty or qty_dict.in_qty or qty_dict.out_qty or qty_dict.bal_qty:
					data.append([item, item_map[item]["item_name"], item_map[item]["description"], wh, batch,
						qty_dict.production_date, qty_dict.expiry_date,
...
def get_columns(filters):
	...
	[_("Warehouse") + ":Link/Warehouse:100"] + [_("Batch") + ":Link/Batch:100"] + \
	[_("Production Date") + ":Date:100"] + [_("Expiry Date") + ":Date:100"] + \
...
def get_stock_ledger_entries(filters):
	...
	return frappe.db.sql("""select sle.item_code, sle.batch_no, b.production_date, b.expiry_date,
		sle.warehouse, sle.posting_date, sle.actual_qty
...
def get_item_warehouse_batch_map(filters, float_precision):
	...
	for d in sle:
		...
		qty_dict.production_date = d.production_date
