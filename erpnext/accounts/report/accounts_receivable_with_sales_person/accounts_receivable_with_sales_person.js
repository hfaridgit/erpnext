...
frappe.query_reports["Accounts Receivable with Sales Person"] = {
	"filters": [
		{
			"fieldname":"company",
			"label": __("Company"),
	...
	onload: function(report) {
		report.page.add_inner_button(__("Accounts Receivable Summary"), function() {
			...
			frappe.set_route('query-report', 'Accounts Receivable Summary with Sales Person', {company: filters.company, business_unit: filters.business_unit});
		});
	}
}
