...
def get_data(accounts, filters, based_on):
	...
	set_gl_entries_by_account(filters.get("company"), filters.get("from_date"), filters, 
...
def set_gl_entries_by_account(company, from_date, filters, to_date, based_on, gl_entries_by_account,
	...
	if filters.get("business_unit"):
		...
		additional_conditions.append("and business_unit = %(business_unit)s")
