...
from erpnext.accounts.report.accounts_receivable_with_sales_person.accounts_receivable_with_sales_person import ReceivablePayableReport
...
class AccountsReceivableSummary(ReceivablePayableReport):
	...
	def get_data(self, party_naming_by, args):
		...
		for party, party_dict in partywise_total.items():
			...
			if args.get("party_type") == "Customer":
				row += [self.get_territory(party), self.get_customer_group(party), self.get_sales_person(party)]
			if args.get("party_type") == "Supplier":
	...
	def get_voucherwise_data(self, party_naming_by, args):
		...
		if args.get("party_type") == "Customer":
			cols += ["territory", "customer_group", "sales_person", "remarks"]
	...
	def get_sales_person(self, party):
		return frappe.db.get_value('Sales Team', {'parent': party}, 'sales_person')
